...
<div class="container"> 
	<div class="container-fluid padding">
		<div class="row padding">
			...
			<div class='col-md-6'>
				<a href="event_page.php">Create Event</a><br>
				<?php echo "<a href='donator_list.php' >Donator list </a>" ;?><br>
				<a href="update_password.php">Change Password</a><br>
				<?php echo "<a href='user_detail.php' >View Users </a>" ;?><br>
			...
			<div class="col-md-12">
				...
				<p>As an admin ,you can see users profile</p>
			</div>
		</div>
	</div>
</div>
